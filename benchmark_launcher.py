...
if __name__ == "__main__":
    ...
    models = ["Qwen/Qwen2-VL-2B-Instruct", "LanguageBind/Video-LLaVA-7B-hf", "HuggingFaceM4/idefics2-8b", "microsoft/Phi-3.5-vision-instruct", "llava-hf/LLaVA-NeXT-Video-7B-hf"]
    benchmarks = ["vqa2", "docvqa", "scienceqa", "flickr30k"]
